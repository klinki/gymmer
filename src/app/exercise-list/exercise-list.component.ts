import {Component, computed, inject, input, Optional, signal, TemplateRef, ViewChild} from '@angular/core';
...
export class ExerciseListComponent {
  ...
  constructor(@Optional() private dialogRef: MatDialogRef<ExerciseListComponent>) {}
